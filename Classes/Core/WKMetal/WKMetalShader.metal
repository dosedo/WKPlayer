...
//  Metal
//
//  Created by Kidsmiless on 2022/9/12.
//  Copyright © 2022 kidsmiless. All rights reserved.
//
...
vertex ColorInOut vertexShader(         uint            vertexID [[ vertex_id ]],
                               constant WKMetalVertex * in       [[ buffer(0) ]],
                               constant WKMetalMatrix & uniforms [[ buffer(1) ]])
{
    ColorInOut out;
